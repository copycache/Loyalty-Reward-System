...
class Tbl_cash_out_list extends Model
{
    ...
    {
        $query->select(DB::raw('tbl_cash_out_list.cash_out_method_service_charge as service_charge, tbl_cash_out_list.gc_charge as cashout_gc_charge, tbl_cash_out_list.product_charge as cashout_product_charge, tbl_cash_out_list.*,tbl_cash_out_method.*'));
